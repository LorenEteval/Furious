...
from Furious.Library.Utility import parseHostPort
...
class ConfigurationXray(ConfigurationFactory):
    ...
    @staticmethod
    def URI2ProxyOutboundObjectVMess(URI: str) -> typing.Tuple[str, dict]:
        try:
    ...
    @staticmethod
    def URI2ProxyOutboundObjectVLESS(URI: str, **kwargs) -> typing.Tuple[str, dict]:
        result = urlparse(URI)
    ...
    @staticmethod
    def URI2ProxyOutboundObjectSS(URI: str) -> typing.Tuple[str, dict]:
        try:
            result = urlparse(URI)
            remark = unquote(result.fragment)
        except Exception:
    ...
    @staticmethod
    def URI2ProxyOutboundObjectTrojan(URI: str) -> typing.Tuple[str, dict]:
        result = urlparse(URI)
        remark = unquote(result.fragment)
        queryObject = {key: value for key, value in parse_qsl(result.query)}
