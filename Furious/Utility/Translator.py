...
TRANSLATION = {
    ...
    'Route My Traffic Through Tor': {
        ...
        'ZH': '通过Tor路由我的流量',
        'TW': '通過Tor路由我的流量',
        'RU': 'Перенаправить мой трафик через Tor',
    },
    'Global': {
        'ES': 'Global',
        'ZH': '全球',
    ...
    'Import Share Link From Clipboard': {
        ...
        'ZH': '从剪贴板导入分享链接',
        'TW': '從剪貼板導入分享鏈接',
        'RU': 'Импортировать Ссылку Для Подключения из Буфера Обмена',
    },
    'Edit Configuration...': {
    ...
    'Show Progress Bar When Connecting': {
        ...
        'ZH': '连接时显示进度条',
        'TW': '連接時顯示進度條',
        'RU': 'Показывать Прогресс При Подключении',
    },
    'Show Tab And Spaces In Editor': {
        'ES': 'Mostrar Pestaña y Espacios en el Editor',
        'ZH': '在编辑器中显示制表符和空格',
        'TW': '在編輯器中顯示制表符和空格',
        'RU': 'Подсвечивать Табуляцию и Пробелы в Редакторе',
    },
    'VPN Mode': {
        'ES': 'Modo VPN',
        'ZH': 'VPN模式',
    ...
    'VPN Mode Disabled (Administrator)': {
        ...
        'ZH': 'VPN模式已禁用（管理员）',
        'TW': 'VPN模式已禁用（管理員）',
        'RU': 'Режим VPN Недоступен (Администратор)',
    },
    'VPN Mode Disabled (root)': {
        'ES': 'Modo VPN Deshabilitado (root)',
        'ZH': 'VPN模式已禁用（root）',
        'TW': 'VPN模式已禁用（root）',
        'RU': 'Режим VPN Недоступен (root)',
    },
    'Routing Settings...': {
        'ES': 'Ajustes de Enrutamiento...',
        'ZH': '路由设置...',
        'TW': '路由設置...',
        'RU': 'Настройки Маршрутизации...',
    },
    'Tor Relay Settings...': {
    ...
    'Check For Updates': {
        ...
        'ZH': '检查更新',
        'TW': '檢查更新',
        'RU': 'Проверка Наличия Обновлений',
    },
    'About': {
        'ES': 'Sobre',
        'ZH': '关于',
    ...
    'Server configuration empty. Please configure your server first.': {
        ...
        'RU': 'Пустая конфигурация сервера. Пожалуйста, сначала настройте свой сервер.',
    },
    'Select and double click to activate configuration and connect.': {
        ...
        'ZH': '选中并双击以激活配置并连接。',
        'TW': '選中并雙擊以激活配置并連接。',
        'RU': 'Кликните дважды для активации конфигурации и подключения.',
    },
    ...
    f'endpoint in your server configuration.': {
        ...
        'RU': f'{APPLICATION_NAME} не удалось найти корректных конечных точек '
        f'http прокси в вашей конфигурации сервера.',
    },
    ...
    f'endpoint in your server configuration.': {
        ...
        'RU': f'{APPLICATION_NAME} не удалось найти корректных конечных точек '
        f'socks прокси в вашей конфигурации сервера.',
    },
    'Please complete your server configuration.': {
        'ES': 'Complete la configuración de su servidor.',
        'ZH': '请完善您的服务器配置。',
        'TW': '請完善您的服務器配置。',
        'RU': 'Пожалуйста, дополните вашу конфигурацию сервера.',
    },
    ...
    'Invalid JSON data. The content of the clipboard is:': {
        ...
        'RU': 'Некорректный формат JSON. Содержимое буфера обмена:',
    },
    'Import JSON configuration success.': {
        'ES': 'Importación de configuración JSON exitosa.',
        'ZH': '导入JSON配置成功。',
        'TW': '導入JSON配置成功。',
        'RU': 'JSON успешно импортирован.',
    },
    # Export
    'Export': {
        'ES': 'Exportar',
    ...
    'Edit Server Configuration': {
        ...
        'ZH': '编辑服务器配置',
        'TW': '編輯服務器配置',
        'RU': 'Редактировать Конфигурацию Сервера',
    },
    'File': {
        'ES': 'Archivo',
        'ZH': '文件',
    ...
    'Text files (*.json);;All files (*)': {
        ...
        'ZH': '文本文档 (*.json);;所有文件 (*)',
        'TW': '文本文檔 (*.json);;所有文件 (*)',
        'RU': 'Текстовые файлы (*.json);;Все файлы (*)',
    },
    ...
    'Error saving configuration': {
        ...
        'ZH': '保存配置时出错',
        'TW': '保存配置時出錯',
        'RU': 'Ошибка при сохранении конфигурации',
    },
    'Error saving file': {
    ...
    f'It may have been tampered with.': {
        ...
        'RU': f'{APPLICATION_NAME} не удалось востановить конфигурацию вашего сервера.'
        f'Возможно кто-то изменил её.',
    },
    f'The configuration content has been cleared by {APPLICATION_NAME}.': {
        ...
        'RU': f'Содержимое конфигурации было удалено приложением {APPLICATION_NAME}.',
    },
    'Invalid configuration file.': {
        'ES': 'Archivo de configuración inválido.',
        'ZH': '无效的配置文件。',
        'TW': '無效的配置文件。',
        'RU': 'Некорректный файл конфигурации.',
    },
    'Hint': {
        'ES': 'Pista',
        'ZH': '提示',
    ...
    f'The new configuration will take effect the next time you connect.': {
        ...
        'RU': f'Приложение {APPLICATION_NAME} в данный момент подключено.\n\n'
        f'Новая конфигурация вступит в силу при следующем подключении.',
    },
    'Reconnect': {
        'ES': 'Reconectar',
        'ZH': '重新连接',
    ...
    'Invalid server configuration.': {
        ...
        'ZH': '无效的服务器配置。',
        'TW': '無效的服務器配置。',
        'RU': 'Некорректная конфигурация сервара.',
    },
    'Please check your configuration is in valid JSON format:': {
        ...
        'RU': 'Пожалуйста, удостоверьтесть, что ваша конфигурация в JSON формате',
    },
    'Save Changes': {
        'ES': 'Guardar Cambios',
        'ZH': '保存更改',
    ...
    'The content has been modified. Do you want to save the changes?': {
        ...
        'ZH': '内容已修改。您要保存更改吗？',
        'TW': '内容已修改。您要保存更改嗎？',
        'RU': 'Содержимое было изменено. Хотите сохранить изменения?',
    },
    'Discard': {
        'ES': 'Descartar',
        'ZH': '不保存',
    ...
    'Delete these configuration?': {
        ...
        'ZH': '删除这些配置？',
        'TW': '刪除這些配置？',
        'RU': 'Удалить эти конфигурации?',
    },
    'Delete this configuration?': {
        'ES': '¿Eliminar esta configuración?',
        'ZH': '删除此配置？',
        'TW': '刪除此配置？',
        'RU': 'Удалить эту конфигурацию?',
    },
    ...
    'Please save any changes to continue.': {
        ...
        'ZH': '请保存所有更改以继续。',
        'TW': '請保存所有更改以繼續',
        'RU': 'Пожалуйста, сохраните эти изменения перед тем как продолжить.',
    },
    'Edit': {
        'ES': 'Editar',
        'ZH': '编辑',
    ...
    'Error setting indent': {
        ...
        'ZH': '设置缩进时出错',
        'TW': '設置縮進時出錯',
        'RU': 'Ошибка при выставлении отступа',
    },
    'View': {
        'ES': 'Vista',
        'ZH': '显示',
    ...
    'Test Ping Latency': {
        ...
        'ZH': '测试Ping延迟',
        'TW': '測試Ping延遲',
        'RU': 'Проверить задержку',
    },
    'Test Download Speed': {
        'ES': 'Probar La Velocidad de Descarga',
        'ZH': '测试下行速度',
        'TW': '測試下行速度',
        'RU': 'Проверить скорость скачивания',
    },
    'Clear Test Results': {
        'ES': 'Resultados Claros de La Prueba',
        'ZH': '清除测试结果',
        'TW': '清除測試結果',
        'RU': 'Отчистить результаты проверок',
    },
    ...
    'Scroll To Activated Server': {
        ...
        'ZH': '滚动到激活的服务器',
        'TW': '滾動到激活的服務器',
        'RU': 'Вернуться к Активированному Серверу',
    },
    # Edit Routing widget
    'Edit Routing': {
        ...
        'ZH': '编辑路由',
        'TW': '編輯路由',
        'RU': 'Редактировать правила маршрутизации',
    },
    'Type': {
        'ES': 'Tipo',
        'ZH': '类型',
    ...
    'Enter routing remark:': {
        ...
        'ZH': '输入路由名称：',
        'TW': '輸入路由名稱：',
        'RU': 'Введите название правила маршрутизации:',
    },
    'Add': {
        'ES': 'Agregar',
        'ZH': '添加',
    ...
    **dict(
        list(
            [
                f'Edit {coreName} Routing Rules',
                {
                    ...
                    'RU': f'Редактировать правила маршрутизации {coreName}',
                },
            ]
        )
    ...
    f'{XrayCore.name()} Routing Rules': {
        ...
        'RU': f'Правила Маршрутизации {XrayCore.name()}',
    },
    ...
    f'will fall back to proxy all traffic.': {
        ...
        'RU': f'Примечание: Если ACL отсутствует или пуст, {APPLICATION_NAME} '
        f'будет проксировать весь трафикю.',
    },
    f'Note: "Custom" will use acl and mmdb defined in current user configuration.': {
        ...
        'RU': f'Примечание: "Пользовательский" будет использовать ACL и MMBD '
        f'определенные в конфигурации текущего пользователя',
    },
    ...
    'Relay Establish Timeout (seconds)': {
        ...
        'ZH': 'Relay建立超时（秒）',
        'TW': 'Relay建立超時（秒）',
        'RU': 'Таймаут Соединения с Релеем (секунды)',
    },
    # Check For Updates
    ...
    f'{APPLICATION_NAME} is already the latest version.': {
        ...
        'RU': f'Установлена последняя версия приложения {APPLICATION_NAME}.',
    },
    f'Thank you for using {APPLICATION_NAME}.': {
        ...
        'RU': f'Спасибо за то, что пользуетесь {APPLICATION_NAME}',
    },
    # Tray
    'Unconfigured server': {
    ...
    'Invalid server configuration': {
        ...
        'ZH': '无效的服务器配置',
        'TW': '無效的服務器配置',
        'RU': 'Некорректная конфигурация сервера',
    },
    'Failed to start core': {
        'ES': 'No se pudo iniciar el núcleo',
        'ZH': '内核启动失败',
        'TW': '内核啓動失敗',
        'RU': 'Не удалось запустить core',
    },
    'Connection test failed': {
        'ES': 'Falló la prueba de conexión',
        'ZH': '连接测试失败',
        'TW': '連接測試失敗',
        'RU': 'Проверка подключения не пройдена',
    },
    ...
    'Core terminated unexpectedly': {
        ...
        'ZH': '内核意外终止',
        'TW': '内核意外終止',
        'RU': 'Core неожианно завершился',
    },
    'Routing changed: ': {
        'ES': 'Ruta cambiada: ',
        'ZH': '路由已更改：',
        'TW': '路由已更改：',
        'RU': 'Маршрутизация изменилась: ',
    },
    ...
    f'{APPLICATION_NAME} is not able to run on this operating system.': {
        ...
        'RU': f'Невозможно запустить {APPLICATION_NAME} на данной операционной системе.',
    },
    ...
    f'{APPLICATION_NAME} stopped unexpectedly due to an unknown exception.': {
        ...
        'RU': f'Приложение {APPLICATION_NAME} неожиданно остановленно из-за неизвестной ошибки.',
    },
    f'{APPLICATION_NAME} encountered an internal error and needs to be stopped.': {
        ...
        'RU': f'Приложение {APPLICATION_NAME} обнаружило внутреннюю ошибку и требует остановки.',
    },
    'Crash log has been saved to: ': {
        'ES': 'El registro de errores se ha guardado en: ',
        'ZH': '崩溃日志已保存到：',
        'TW': '崩潰日志已保存到：',
        'RU': 'Запись о сбое созранена в: ',
    },
    'Open crash log': {
        'ES': 'Abrir registro de fallas',
        'ZH': '打开崩溃日志',
        'TW': '打開崩潰日志',
        'RU': 'Открыть журнал сбоев',
    },
}
