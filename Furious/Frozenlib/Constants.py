...
"""Define application, platform, network, and filesystem constants."""
...
if PLATFORM == 'Windows':
    ...
    APPLICATION_TUN2SOCKS_DEVICE_NAME = 'utun777'
elif PLATFORM == 'Linux':
    APPLICATION_TUN2SOCKS_DEVICE_NAME = 'utun777'
else:
    APPLICATION_TUN2SOCKS_DEVICE_NAME = ''

APPLICATION_TUN2SOCKS_NETWORK_INTERFACE_NAME = 'en0' if PLATFORM == 'Darwin' else ''
APPLICATION_TUN2SOCKS_GATEWAY_ADDRESS = '10.0.68.1'

if PLATFORM == 'Windows':
    APPLICATION_TUN2SOCKS_IP_ADDRESS = '10.0.68.10'
else:
    APPLICATION_TUN2SOCKS_IP_ADDRESS = APPLICATION_TUN2SOCKS_GATEWAY_ADDRESS

APPLICATION_TUN2SOCKS_INTERFACE_DNS_ADDRESS = '1.1.1.1'
